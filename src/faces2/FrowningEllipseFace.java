 ...
 * @author test
 */
public class FrowningEllipseFace extends EllipseFace {

    public FrowningEllipseFace(int x, int y, int size) {
        super(x, y, size);
    }
    
    @Override
    public void drawFacialExpression(){// place the eyes and mouth dependign on position and facesize
